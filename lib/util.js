 ...
 * @param {string} allowed_methods - Allowed HTTP methods in CORS.
 * @param {string} allowed_headers - Allowed HTTP headers in CORS.
 * @returns {import('.').CorsHandlerObject} - CORS handler object.
 */
